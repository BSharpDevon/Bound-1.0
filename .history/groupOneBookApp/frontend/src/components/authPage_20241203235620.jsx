    ...
    <div className="auth-page">
      ...
      <div className="intro-section">
        <div id="introMessage">
          ...
          <p>
Discover the perfect book. Bound searches millions of titles to match you and your friend’s unique tastes, delivering a recommendation made just for you.</p>
