  ...
  return (
    <div className="auth-page">
      ...
      <div className="intro-section">
        <div id="introMessage">
          <h1>Let Your Friends Find Your 
            <h1 id="header-highlight>Next Best Book</h1></h1>
          <p>
Bound searches millions of titles to match you and your friend’s unique tastes. Sign up for a free unique book recommendation.</p>
