    ...
    <div className="auth-page">
      ...
      <div className="intro-section">
        <div id="introMessage">
          ...
          <p>
Can't choose a book? Bound searches thousands of titles to match your reading taste with a friend's, delivering a magical recommendation you'll both enjoy.</p>
